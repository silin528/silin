...
public class ProductServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		}else if("searchServlet".equals(methodName)){
	...
	//搜索栏
	public void SearchServlet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		//1.接收参数
		...
		try {
			Product product = productService.searchName(pname);
